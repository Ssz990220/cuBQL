...
CUBQL_HOST_INSTANTIATE_WIDE_BVH(CUBQL_INSTANTIATE_T,CUBQL_INSTANTIATE_D,4)
CUBQL_HOST_INSTANTIATE_WIDE_BVH(CUBQL_INSTANTIATE_T,CUBQL_INSTANTIATE_D,8)
#else
// default instantiation(s) for float3 only
CUBQL_HOST_INSTANTIATE_BINARY_BVH(float,3)
CUBQL_HOST_INSTANTIATE_WIDE_BVH(float,3,4)
CUBQL_HOST_INSTANTIATE_WIDE_BVH(float,3,8)
#endif
